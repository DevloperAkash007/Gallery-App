...
class Gallery extends Component {
  ...
  getThumbnailItem = () => {
    ...
    const thumbnailItemList = imagesList.map(eachItem => (
      <ThumbnailItem
        key={eachItem.id}
        clickImage={this.clickImage}
        isActive={thumbnailUrl === eachItem.thumbnailUrl}
  ...
  render() {
    ...
    const thumbnailItemList = this.getThumbnailItem()
